      ...
      <nav className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-7xl hidden md:block">
        <div className="bg-white/80 backdrop-blur-xl rounded-full border-2 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <Link href="/" className="flex items-center gap-3 pl-2 hover:opacity-80 transition-opacity">
            ...
            <div className="flex items-center gap-2">
              ...
              <NavPill href="#docs" active={false}>DOCS</NavPill>
            </div>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 md:hidden bg-white/90 backdrop-blur-xl border-b-2 border-black">
        ...
        {mobileMenuOpen && (
          <div className="border-t-2 border-black bg-white p-4 space-y-3">
            ...
            <MobileNavLink href="/sender" active={isActive("/sender")} onClick={() => setMobileMenuOpen(false)}>
              <Zap size={16} className="inline mr-2" />
              SENDER
            </MobileNavLink>
            <MobileNavLink href="#features" active={false} onClick={() => setMobileMenuOpen(false)}>
              FEATURES
            </MobileNavLink>
            <MobileNavLink href="#docs" active={false} onClick={() => setMobileMenuOpen(false)}>
              DOCS
            </MobileNavLink>
